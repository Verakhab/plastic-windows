...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _plugins_Sash_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../plugins/Sash.js */ \"./src/plugins/Sash.js\");\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  name: \"FormConfig\",\n\n  data() {\n    return {\n      sash: {\n        name: this.$store.state.window[this.$store.state.numberIndex].name,\n        typeSash: this.$store.state.window[this.$store.state.numberIndex].typeSash,\n        sideOpen: this.$store.state.window[this.$store.state.numberIndex].sideOpen,\n        configSash: this.$store.state.window[this.$store.state.numberIndex].configSash,\n        mosqito: this.$store.state.window[this.$store.state.numberIndex].mosqito,\n        image: this.$store.state.window[this.$store.state.numberIndex].image\n      }\n    };\n  },\n\n  methods: {\n    typeWindow() {\n      this.$store.commit(\"changeSash\", new _plugins_Sash_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"Глухое\", \"window\", false, \"deaf\", false, __webpack_require__(/*! ../assets/images/deaf.jpg */ \"./src/assets/images/deaf.jpg\")));\n      this.sash.name = this.$store.state.window[this.$store.state.numberIndex].name;\n      this.sash.typeSash = this.$store.state.window[this.$store.state.numberIndex].typeSash;\n      this.sash.sideOpen = this.$store.state.window[this.$store.state.numberIndex].sideOpen;\n      this.sash.configSash = this.$store.state.window[this.$store.state.numberIndex].configSash;\n      this.sash.mosqito = this.$store.state.window[this.$store.state.numberIndex].mosqito;\n      this.sash.image = this.$store.state.window[this.$store.state.numberIndex].image;\n    },\n\n    typeDoor() {\n      this.$store.commit(\"changeSash\", new _plugins_Sash_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"Правое открывание\", \"door\", \"right\", \"rotary\", false, __webpack_require__(/*! ../assets/images/Right-opening-door.jpg */ \"./src/assets/images/Right-opening-door.jpg\")));\n      this.sash.name = this.$store.state.window[this.$store.state.numberIndex].name;\n      this.sash.typeSash = this.$store.state.window[this.$store.state.numberIndex].typeSash;\n      this.sash.sideOpen = this.$store.state.window[this.$store.state.numberIndex].sideOpen;\n      this.sash.configSash = this.$store.state.window[this.$store.state.numberIndex].configSash;\n      this.sash.mosqito = this.$store.state.window[this.$store.state.numberIndex].mosqito;\n      this.sash.image = this.$store.state.window[this.$store.state.numberIndex].image;\n    },\n\n    sideRight() {\n      this.sash.typeSash === \"window\" && this.sash.configSash === \"rotary\" ? this.$store.commit(\"changeSash\", new _plugins_Sash_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"Правое открывание\", \"window\", \"right\", \"rotary\", this.sash.mosqito, __webpack_require__(/*! ../assets/images/Right-opening-window.jpg */ \"./src/assets/images/Right-opening-window.jpg\"))) : this.sash.typeSash === \"window\" && this.sash.configSash === \"swingOut\" ? this.$store.commit(\"changeSash\", new _plugins_Sash_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"Поворотно-откидное правое\", \"window\", \"right\", \"swingOut\", this.sash.mosqito, __webpack_require__(/*! ../assets/images/Swing-out-right.jpg */ \"./src/assets/images/Swing-out-right.jpg\"))) : this.$store.commit(\"changeSash\", new _plugins_Sash_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"Правое открывание\", \"door\", \"right\", \"rotary\", false, __webpack_require__(/*! ../assets/images/Right-opening-door.jpg */ \"./src/assets/images/Right-opening-door.jpg\")));\n      this.sash.name = this.$store.state.window[this.$store.state.numberIndex].name;\n      this.sash.typeSash = this.$store.state.window[this.$store.state.numberIndex].typeSash;\n      this.sash.sideOpen = this.$store.state.window[this.$store.state.numberIndex].sideOpen;\n      this.sash.configSash = this.$store.state.window[this.$store.state.numberIndex].configSash;\n      this.sash.mosqito = this.$store.state.window[this.$store.state.numberIndex].mosqito;\n      this.sash.image = this.$store.state.window[this.$store.state.numberIndex].image;\n    },\n\n    sideLeft() {\n      this.sash.typeSash === \"window\" && this.sash.configSash === \"rotary\" ? this.$store.commit(\"changeSash\", new _plugins_Sash_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"Левое открывание\", \"window\", \"left\", \"rotary\", this.sash.mosqito, __webpack_require__(/*! ../assets/images/Left-opening-window.jpg */ \"./src/assets/images/Left-opening-window.jpg\"))) : this.sash.typeSash === \"window\" && this.sash.configSash === \"swingOut\" ? this.$store.commit(\"changeSash\", new _plugins_Sash_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"Поворотно-откидное левое\", \"window\", \"left\", \"swingOut\", this.sash.mosqito, __webpack_require__(/*! ../assets/images/Swing-out-left.jpg */ \"./src/assets/images/Swing-out-left.jpg\"))) : this.$store.commit(\"changeSash\", new _plugins_Sash_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"Левое открывание\", \"door\", \"left\", \"rotary\", false, __webpack_require__(/*! ../assets/images/Left-opening-door.jpg */ \"./src/assets/images/Left-opening-door.jpg\")));\n      this.sash.name = this.$store.state.window[this.$store.state.numberIndex].name;\n      this.sash.typeSash = this.$store.state.window[this.$store.state.numberIndex].typeSash;\n      this.sash.sideOpen = this.$store.state.window[this.$store.state.numberIndex].sideOpen;\n      this.sash.configSash = this.$store.state.window[this.$store.state.numberIndex].configSash;\n      this.sash.mosqito = this.$store.state.window[this.$store.state.numberIndex].mosqito;\n      this.sash.image = this.$store.state.window[this.$store.state.numberIndex].image;\n    },\n\n    configDeaf() {\n      this.$store.commit(\"changeSash\", new _plugins_Sash_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"Глухое\", \"window\", false, \"deaf\", false, __webpack_require__(/*! ../assets/images/deaf.jpg */ \"./src/assets/images/deaf.jpg\")));\n      this.sash.name = this.$store.state.window[this.$store.state.numberIndex].name;\n      this.sash.typeSash = this.$store.state.window[this.$store.state.numberIndex].typeSash;\n      this.sash.sideOpen = this.$store.state.window[this.$store.state.numberIndex].sideOpen;\n      this.sash.configSash = this.$store.state.window[this.$store.state.numberIndex].configSash;\n      this.sash.mosqito = this.$store.state.window[this.$store.state.numberIndex].mosqito;\n      this.sash.image = this.$store.state.window[this.$store.state.numberIndex].image;\n    },\n\n    configRotary() {\n      this.$store.commit(\"changeSash\", new _plugins_Sash_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"Правое открывание\", \"window\", this.sash.sideOpen === \"left\" ? \"left\" : \"right\", \"rotary\", this.sash.mosqito, __webpack_require__(\"./src/assets/images sync recursive ^\\\\.\\\\/.*\\\\-opening\\\\-window\\\\.jpg$\")(`./${this.sash.sideOpen === \"left\" ? \"Left\" : \"Right\"}-opening-window.jpg`)));\n      this.sash.name = this.$store.state.window[this.$store.state.numberIndex].name;\n      this.sash.typeSash = this.$store.state.window[this.$store.state.numberIndex].typeSash;\n      this.sash.sideOpen = this.$store.state.window[this.$store.state.numberIndex].sideOpen;\n      this.sash.configSash = this.$store.state.window[this.$store.state.numberIndex].configSash;\n      this.sash.mosqito = this.$store.state.window[this.$store.state.numberIndex].mosqito;\n      this.sash.image = this.$store.state.window[this.$store.state.numberIndex].image;\n    },\n\n    configSwingOut() {\n      this.$store.commit(\"changeSash\", new _plugins_Sash_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"Поворотно-откидное правое\", \"window\", this.sash.sideOpen === \"left\" ? \"left\" : \"right\", \"swingOut\", this.sash.mosqito, __webpack_require__(\"./src/assets/images sync recursive ^\\\\.\\\\/Swing\\\\-out\\\\-.*\\\\.jpg$\")(`./Swing-out-${this.sash.sideOpen === \"left\" ? \"left\" : \"right\"}.jpg`)));\n      this.sash.name = this.$store.state.window[this.$store.state.numberIndex].name;\n      this.sash.typeSash = this.$store.state.window[this.$store.state.numberIndex].typeSash;\n      this.sash.sideOpen = this.$store.state.window[this.$store.state.numberIndex].sideOpen;\n      this.sash.configSash = this.$store.state.window[this.$store.state.numberIndex].configSash;\n      this.sash.mosqito = this.$store.state.window[this.$store.state.numberIndex].mosqito;\n      this.sash.image = this.$store.state.window[this.$store.state.numberIndex].image;\n    },\n\n    changeMosqito() {\n      this.$store.commit(\"addMosqito\", this.$store.state.numberIndex);\n      this.$store.state.window[this.$store.state.numberIndex].mosqito;\n    },\n\n    closeForm() {\n      this.$store.commit(\"isActive\");\n    }\n\n  }\n});\n\n//# sourceURL=webpack:///./src/components/FormConfig.vue?./node_modules/cache-loader/dist/cjs.js??ref--13-0!./node_modules/babel-loader/lib!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue */ \"./node_modules/vue/dist/vue.runtime.esm.js\");\n/* harmony import */ var _App_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./App.vue */ \"./src/App.vue\");\n/* harmony import */ var _router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./router */ \"./src/router/index.js\");\n/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./store */ \"./src/store/index.js\");\n/* harmony import */ var _assets_vendor_normalize_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./assets/vendor/normalize.css */ \"./src/assets/vendor/normalize.css\");\n/* harmony import */ var _assets_vendor_normalize_css__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_assets_vendor_normalize_css__WEBPACK_IMPORTED_MODULE_4__);\n/* harmony import */ var _assets_vendor_fonts_stylesheet_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./assets/vendor/fonts/stylesheet.css */ \"./src/assets/vendor/fonts/stylesheet.css\");\n/* harmony import */ var _assets_vendor_fonts_stylesheet_css__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_assets_vendor_fonts_stylesheet_css__WEBPACK_IMPORTED_MODULE_5__);\n\n\n\n\n\n\nvue__WEBPACK_IMPORTED_MODULE_0__[\"default\"].config.productionTip = false;\nnew vue__WEBPACK_IMPORTED_MODULE_0__[\"default\"]({\n  router: _router__WEBPACK_IMPORTED_MODULE_2__[\"default\"],\n  store: _store__WEBPACK_IMPORTED_MODULE_3__[\"default\"],\n  render: h => h(_App_vue__WEBPACK_IMPORTED_MODULE_1__[\"default\"])\n}).$mount(\".app\");\n\n//# sourceURL=webpack:///./src/main.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue */ \"./node_modules/vue/dist/vue.runtime.esm.js\");\n/* harmony import */ var vue_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vue-router */ \"./node_modules/vue-router/dist/vue-router.esm.js\");\n/* harmony import */ var _views_Home_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../views/Home.vue */ \"./src/views/Home.vue\");\n\n\n\nvue__WEBPACK_IMPORTED_MODULE_0__[\"default\"].use(vue_router__WEBPACK_IMPORTED_MODULE_1__[\"default\"]);\nconst routes = [{\n  path: \"/\",\n  name: \"Home\",\n  component: _views_Home_vue__WEBPACK_IMPORTED_MODULE_2__[\"default\"]\n}, {\n  path: \"/calc-list\",\n  name: \"Calc-list\",\n  component: () => __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(null, /*! ../views/Calc-list.vue */ \"./src/views/Calc-list.vue\"))\n}, {\n  path: \"/calc-done\",\n  name: \"Calc-done\",\n  component: () => __webpack_require__.e(/*! import() */ 1).then(__webpack_require__.bind(null, /*! ../views/Calc-done.vue */ \"./src/views/Calc-done.vue\"))\n}];\nconst router = new vue_router__WEBPACK_IMPORTED_MODULE_1__[\"default\"]({\n  mode: \"history\",\n  base: \"/\",\n  routes\n});\n/* harmony default export */ __webpack_exports__[\"default\"] = (router);\n\n//# sourceURL=webpack:///./src/router/index.js?");
